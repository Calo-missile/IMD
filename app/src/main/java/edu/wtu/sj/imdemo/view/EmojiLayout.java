package edu.wtu.sj.imdemo.view;
...
import edu.wtu.sj.imdemo.adapter.FaceGvAdapter;
import edu.wtu.sj.imdemo.adapter.FaceVpAdapter;
...
public class EmojiLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void initView() {
        View view = View.inflate(getContext(), R.layout.emtion_edittext, null);
        initUI(view);
        addView(view);
        initEmoji();
        initListener();
    ...
    private void initStaticFaces() {
        try {
            ...
            String[] faces = getContext().getAssets().list("png");
    ...
    private View viewPagerItem(int position) {
        View layout = View.inflate(getContext(), R.layout.emtion_gridview, null);// 表情布局
        ...
        //LogUtils.d("EmojiLayout--viewPagerItem"+position);
        // 单击表情执行的操作
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                insert(getFace(png));
                LogUtils.d("EmojiLayout--viewPagerItem"+getFace(png));
            }
        });
        return gridview;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_qq_face:
                ToastUtils.showToastSafe(getContext(),"QQ表情");
                vpEmoji.setCurrentItem(0);
                break;
            case R.id.tv_emoji_face:
                ToastUtils.showToastSafe(getContext(),"哈哈表情");
